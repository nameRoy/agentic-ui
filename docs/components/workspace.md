...
<code src="../demos/workspace-file-custom-preview-flow.tsx">文件管理 - 自定义预览流程</code>
<code src="../demos/workspace-file-actionref-demo.tsx">文件管理 - ActionRef 外部控制</code>
<code src="../demos/workspace-file-search-demo.tsx">文件管理 - 搜索过滤</code>
<code src="../demos/workspace-locate.tsx">定位功能 - 文件与网页</code>
<code src="../demos/workspace-file-custom-render-demo.tsx">文件管理 - 自定义渲染</code>
...
| ~~onToggleGroup~~   | 已废弃，请使用 `onGroupToggle`                                | `(groupType: FileType, collapsed: boolean) => void`                                                             | -       | 2.29.0   |
