...
export const cnLabels = {
  ...
  // SuggestionList related
  'suggestion.area': '追问区域',
  'suggestion.label': '追问建议',
  ...
  'common.type': '类型',
  'common.content': '内容',
  'common.understand': '理解问题',
  'common.conversionRate': '转化率',
  'common.conversion': '转化',
  'common.assignTo': '指派给',
  'common.searchFileName': '搜索文件名',
  'common.fileProcessFailed': '文件处理失败',
  'common.loadTextFailed': '加载文本内容失败',
  ...
  'common.audio': '音频',
  'common.video': '视频',
  'common.imageLink': '图片链接',
  'common.textFile': '文本文件',
  'common.compressedFile': '压缩文件',
...
export const enLabels: typeof cnLabels = {
  ...
  'chat.history.favorited': 'Favorited',
  ...
  'chatFlow.shareDialog': 'Share conversation',
  // SuggestionList related
  'suggestion.area': 'Follow-up area',
  'suggestion.label': 'Follow-up suggestions',
  ...
  'common.understand': 'Understand the question',
  'common.conversionRate': 'Conversion rate',
  'common.conversion': 'Conversion',
  'common.assignTo': 'Assign to',
  'common.searchFileName': 'Search file name',
  'common.fileProcessFailed': 'File processing failed',
  'common.loadTextFailed': 'Failed to load text content',
  ...
  'common.audio': 'Audio',
  'common.video': 'Video',
  'common.imageLink': 'Image link',
  'common.textFile': 'Text file',
  'common.compressedFile': 'Compressed file',
